...
public abstract class BaseZnzActivity extends SwipeBackActivity implements IView {
    ...
    protected boolean isNoEditFocusHandle;//控制不处理输入框焦点问题
...
//            znzToolBar.setOnNavLeftClickListener(v -> finish());
     ...
     * 设置不处理焦点点击
     *
     * @param noEditFocusHandle
     */
    public void setNoEditFocusHandle(boolean noEditFocusHandle) {
        isNoEditFocusHandle = noEditFocusHandle;
    }
